...
if ($_SESSION["autenticado"] == "1") {
    ...
    if ($_POST['tarea'] == 'validar'){
		$cliente = new Cliente('','',$_POST['documento'], '', '','','','','','','','','','','','','','','','','','','','','','','','');
		$ConsultarCliente=$cliente->existeCliente();
		if(!$ConsultarCliente){
			echo "<script>window.location.href='CrearCliente.php';</script>";
		}
		else{
			$resp = $cliente->buscarCliente('documento',$_POST['documento']);
			$_SESSION['cliente']=serialize($resp[0]);
			echo "<script> window.location.href='EditarCliente.php';</script>";
		}
	}
	$_SESSION['validaclie']=$_POST['documento'];
	}
?>
        ...
        <tr>
          <td align="left" valign="middle"><table width="35" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              <td><a href="javascript:cliente_val('validar')"><img src="imagenes/seleccionar.png" width="32" height="32" title="Validar Cliente" /></a></td>
