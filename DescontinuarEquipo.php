...
<title>Descontinuar Equipo</title>
  ...
  <tr>
    <td align="center" valign="top"><form action="" method="post" name="form1" class="FormGeneral" id="form1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center" valign="middle"><strong>DESCONTINUAR EQUIPO</strong></td>
        </tr>
      </table>
            ...
            <tr>
              <td height="132" align="center" valign="top"><table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="175" align="center">Referencia del Equipo</td>
                  <td width="474" align="center">Nombre del Equipo</td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td align="center" valign="middle">&nbsp;</td>
                  <td align="center"><input name="cantidad" type="text" id="cantidad" size="20" maxlength="100" class="campos_mayus" value="<?php echo $equipo->cantidad; ?>" disabled="disabled" /></td>
                  <td align="center"><input type="checkbox" name="descontinuar" id="descontinuar"</td>
                  </tr>
              </table></td>
              </tr>
          </table></td>
