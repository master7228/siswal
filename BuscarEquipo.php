	 ...
	 if(!empty($_POST['tarea']) && $_POST['tarea']=='editar'){
		...
		for($i=0; $i<count($equipos); $i++){
			...
			if($equipo->id==$_POST['id']){
				...
				echo "<script> window.location.href='VerEquipo.php';</script>";
			}
		}
	 }
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td><a href="CrearEquipo.php"><img src="imagenes/nueva_obra.png" width="32" height="32" border="0" title="Nuevo Equipo" /></a></td>
                ...
                <td><a href="BuscarEquipoEditar.php"><img src="imagenes/editar.png" width="32" height="32" title="Editar EQuipo" /></a></td>
                <!--<td><a href="ListadoEquiposExcel.php"><img src="imagenes/exportar_excel.png" width="32" height="32" border="0" title="Exportar a Excel" /></a></td>-->
			...
			<table width="350" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="BuscarUsuario">BUSCAR EQUIPO </td>
                  </tr>
                  <tr>
						...
						<table width="1000" border="1" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
                           ...
                           <tr bgcolor="#999999">
							...
							<td width="64" align="center" valign="middle"><strong>Ver</strong></td>
						  </tr>
						  <?php
							...
							<tr align="left" class="TablaUsuarios">
						      ...
						      <td width="64" align="center" valign="middle"><a href="javascript:enviar_form_clientes('editar','<?php echo $equipo->id; ?>')"><img src="imagenes/buscar.png" width="28" height="28" /></td>
							</tr>
