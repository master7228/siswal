...
<body onLoad="mueveReloj();" onKeyDown = "showDown(window.event)" onKeyDown = "showDown(window.event)">
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                ...
                <td><a href="BuscarEquipoEditar.php"><img src="imagenes/editar.png" width="33" height="32" border="0" title="Editar Equipo" /></a></td>
          ...
          <tr>
            <td height="77" align="center"><p><img src="imagenes/equipos_opaco.png" width="300" height="300" /></p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
