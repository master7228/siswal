...
if ($_SESSION["autenticado"] == "1") {
	...
	$contac = new ContactoProveedor('','','','','','','','','','','','','','');
	$resp = $contac->buscarContacto($proveedor->id);
	$_SESSION['cont']='1';
	$_SESSION['gcont']= '1';
	if($resp){
		$ver_contactos=1;
...
<title>Crear Contactos del Proveedor</title>
        ...
        <tr>
          <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              <td><a href="javascript:valcontactospro('guardar')"><img src="imagenes/guardar.png" alt="guardar" width="32" height="32" border="0" title="Guardar Informaci&oacute;n" onClick="return validarEmail(email,'email')"/></a></td>
              ...
              <td><a href="CrearProveedor.php"><img src="imagenes/flecha.png" width="32" height="32" border="0" title="Regresar al Proveedor" /></a></td>
            </tr>
          </table></td>
        </tr>
        <tr>
                  ...
                  <tr align="center">
                    <td width="718" height="524" valign="top">  <table width="698" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left"><input name="documento" type="text" class="campos_mayus" id="documento" onkeypress="javascript:return Numeros(event)" maxlength="15"/>                          
                      ...
                      <tr>
                        <td width="11" align="left" valign="middle">&nbsp;</td>
                        <td width="246" align="left">E-mail</td>
                        <td width="12" align="left">&nbsp;</td>
                        <td colspan="3" align="left">Telefono</td>
                        <td width="190" align="left">Cargo</td>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left"><input name="tarea" type="hidden" id="tarea" />
                          <input name="telefono" type="text" id="telefono" maxlength="15" class="campos_mayus" onkeypress="javascript:return Numeros(event)"/>
                          &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;                            &nbsp;*</td>
                        <td align="left"><input name="cargo" type="text" class="campos_mayus" id="cargo" onkeypress="javascript:return Letras(event)" maxlength="30"/></td>
                        <td align="left">&nbsp;</td>
                        </tr>
                      <tr>
                        <td align="center" valign="middle">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td align="left"><input name="profesion" type="text" class="campos_mayus" id="profesion" onkeypress="javascript:return Letras(event)" maxlength="30"/></td>
                        <td align="left">&nbsp;</td>
                      </tr>
                      <tr>
                        <td align="center" valign="middle">&nbsp;</td>
                        <td align="left">&nbsp;</td>
                        <td align="left">&nbsp;</td>
                        <td width="68" align="left">Dia</td>
                        <td width="63" align="left"><div align="left">Mes</div></td>
                        <td align="left"><div align="left">A&ntilde;o</div></td>
                        <td align="left">&nbsp;</td>
                        <td align="left">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="8" align="center" valign="middle"><p>&nbsp;</p>
						</td>
                        </tr>
                    </table>
