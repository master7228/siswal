  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="" class="TablaUsuarios">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td><a href="BuscarEquipoTraslado.php"><img src="imagenes/nueva_bodega.png" width="32" height="32" title="Nuevo Traslado" /></a></td>
          ...
          <tr>
            <td align="center">
			<p><img src="imagenes/traslados_opaco.png" width="300" height="301" /></p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
