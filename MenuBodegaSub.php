...
<title>Menu Bodega Subalquiler</title>
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="" class="TablaUsuarios">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td><a href="CrearBodegaSub.php" target="_parent"><img src="imagenes/nueva_bodega.png" alt="nuevo" width="32" height="32" border="0" title="Nueva Bodega Subalquiler" /></a></td>
                ...
                <td><a href="BuscarBodegaSubEditar.php"><img src="imagenes/editar.png" width="32" height="32" border="0" title="Editar Bodega Subalquiler" /></a></td>
          ...
          <tr>
            <td align="center">
			<p><img src="imagenes/bodega_opaco.png" width="300" height="300" /></p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
