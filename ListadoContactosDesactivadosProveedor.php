...
if ($_SESSION["autenticado"] == "1") {
	...
	if(!empty($_POST['tarea']) and $_POST['tarea']=='activar'){
			...
			if($estado){
				...
				echo '<script>window.location="ListadoContactosDesactivadosproveedor.php";</script>';
			}else{
        ...
        <tr>
          <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              ...
              <td><a href="EditarContactosproveedor.php"><img src="imagenes/flecha.png" width="32" height="32" border="0" title="Volver" /></a></td>
			  </tr>
          </table></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><span class="style1">CONTACTOS DESACTIVADOS DEL PROVEEDOR</span></td>
        </tr>
        <tr>
