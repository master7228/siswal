<?php
 ...
 if($_SESSION["autenticado"] == "1"){
	 ...
	 $resp=unserialize($_SESSION['proveedores']);
...
<table width="1166" border="1" cellpadding="0" cellspacing="0">
						  <tr>
						    <td height="37" colspan="6" align="center"><span class="style1">REGISTROS ENCONTRADOS </span></td>
			              </tr>
  <tr>
						   ...
						   <?php
							...
							?>
						  <tr>
							<td width="281" align="center" bgcolor="#CCCCCC"><strong>Nro de Identificaci&oacute;n</strong></td>
							<td width="281" align="center" bgcolor="#CCCCCC"><strong>Nombre del Proveedor </strong></td>
							<td width="170" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Direcci&oacute;n</strong></td>
							<td width="150" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Tel&eacute;fono</strong></td>
							<td width="200" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Email</strong></td>
							<td width="70" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Estado</strong></td>
						  </tr>
						 
							<tr align="left" class="TablaUsuarios">
							  <td><?php echo $proveedor->documento; ?></a></td>
								<td><?php echo ($proveedor->nombre1."  ".$proveedor->nombre2."  ".$proveedor->apellido1."  ".$proveedor->apellido2); ?></td>
							    <td align="left" valign="middle"> <?php echo $proveedor->direccion; ?></td>                               
					            <td align="left" valign="middle"> <?php echo $proveedor->telefono; ?></td> 
								<td align="left" valign="middle"> <?php echo $proveedor->email; ?></td>                                
  <td align="center" valign="middle"><?php if($proveedor->estado==1){echo "ACTIVO";}else{echo "INACTIVO";} ?>  
  </tr>
						
						<?php 
							$contacto= new ContactoProveedor('','','','','','','','','','','','','','');
							$buscar_cont = $contacto->buscarContacto($proveedor->documento);
							if($buscar_cont){ ?>
