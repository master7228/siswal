...
if ($_SESSION["autenticado"] == "1") {
	...
	if(!empty($_POST['tarea']) and $_POST['tarea']=='activar'){
			...
			$contacto->estado="1";
			if($estado){
				/*echo "<script>alert('El Contacto ha sido activado correctamente');</script> ";*/
				echo '<script>window.location="ListadoContactosDesactivadosBodega.php";</script>';
			}else{
        ...
        <tr>
          <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              ...
              <td><a href="EditarContactosBodega.php"><img src="imagenes/flecha.png" width="32" height="32" border="0" title="Volver" /></a></td>
			  </tr>
          </table></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><span class="style1">CONTACTOS DESACTIVADOS DE BODEGA</span></td>
        </tr>
        <tr>
