          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                ...
                <td><img src="imagenes/guardar_opaco.png" title="Guardar" width="32" height="32" /></td>
                <td><a href="BuscarUsuario.php" target="_parent"><img src="imagenes/buscar.png" alt="buscar" width="32" height="32" border="0" title="Buscar Usuario"/></a></td>
          ...
          <tr>
			...
			<table width="350" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="BuscarUsuario">BUSCAR USUARIOS EDITAR </td>
                  </tr>
                  <tr>
			...
			?>
						<table width="600" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
							<td width="225" align="center" bgcolor="#CCCCCC">N&uacute;mero de Identificaci&oacute;n</td>
							<td width="175" bgcolor="#CCCCCC">Nombre del Usuario </td>
							<td width="100" align="center" valign="middle" bgcolor="#CCCCCC">Estado</td>
							<td width="100" align="center" valign="middle" bgcolor="#CCCCCC">Editar</td>
						  </tr>
						  <?php
							...
							<tr align="left" class="TablaUsuarios">
								...
								<td width="100" align="center" valign="middle"><?php if($usuario->estado==1){echo "ACTIVO";}else{echo "INACTIVO";} ?>
							  <td width="100" align="center" valign="middle"><a href="javascript:eviar_form_usuarios('editar','<?php echo $usuario->id; ?>')"><img src="imagenes/editar.png" width="30" height="30" /></a></td>
							</tr>
						<?php } ?>
			  </table>
						<?php
