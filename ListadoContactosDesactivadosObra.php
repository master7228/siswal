...
if ($_SESSION["autenticado"] == "1") {
	...
	if(!empty($_POST['tarea']) and $_POST['tarea']=='activar'){
			...
			if($estado){
				...
				echo '<script>window.location="ListadoContactosDesactivadosObra.php";</script>';
			}else{
...
<title>Editar Contactos de la Obra</title>
        ...
        <tr>
          <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              ...
              <td><a href="EditarContactosObra.php"><img src="imagenes/flecha.png" width="32" height="32" border="0" title="Volver" /></a></td>
			  </tr>
          </table></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><span class="style1">CONTACTOS DESACTIVADOS DE LA OBRA</span></td>
        </tr>
        <tr>
          <td align="left" valign="middle">&nbsp;</td>
        </tr>
      </table>
      <table width="800" height="auto" border="0" cellspacing="0" cellpadding="8" >
        <tr>
            ...
            <tr>
              <td width="819" align="center"><table width="700" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr align="left" class="TablaUsuarios">
                  ...
                  <td width="100" align="center" valign="middle"><a href="javascript:enviar_form_edit_contactos('activar','<?php echo $contacto->id; ?>')"><img src="imagenes/activar_user.png" width="30" height="30" border="0" title="Activar contacto"/></a></td>
                </tr>
                <?php 	} 
							} 
						}else{
