	 ...
	 if(!empty($_POST['tarea']) && $_POST['tarea']=='seleccionar'){
		...
		for($i=0; $i<count($equipos); $i++){
			...
			if($equipo->id==$_POST['id']){
				...
				echo "<script> window.location.href='RealizarTraslado.php';</script>";
			}
		}
	 }
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td><a href="BuscarEquipoTraslado.php"><img src="imagenes/nueva_obra.png" width="32" height="32" border="0" title="Nuevo Equipo" /></a></td>
			...
			<table width="350" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="BuscarUsuario">BUSCAR EQUIPO TRASLADO</td>
                  </tr>
                  <tr>
