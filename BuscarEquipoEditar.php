<?php
 ...
 if($_SESSION["autenticado"] == "1"){
	 ...
	 if(!empty($_POST['select']) && !empty($_POST['palabra']) ){
		 $equipo = new Equipo("","","","","","","","","","","","","","","","","","","","","","","","");
		 $resp = $equipo->buscarEquipoEditar($_POST['select'],$_POST['palabra']);
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                ...
                <td><img src="imagenes/editar.png" width="32" height="32" title="Editar EQuipo" /></td>
			...
			<table width="350" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="BuscarUsuario">BUSCAR EQUIPO EDITAR</td>
                  </tr>
                  <tr>
						...
						<table width="1000" border="1" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
                           ...
                           <tr bgcolor="#999999">
                            ...
                            <td width="64" align="center" valign="middle"><strong>Editar</strong></td>
						  </tr>
						  <?php
							...
							<tr align="left" class="TablaUsuarios">
						      ...
						      <td width="64" align="center" valign="middle"><?php echo $equipo->cantidad; ?></td>
                               <td width="64" align="center" valign="middle"><a href="javascript:enviar_form_clientes('editar','<?php echo $equipo->id; ?>')"><img src="imagenes/editar.png" width="32" height="32" /></a></td>
							</tr>
