<?php
 ...
 if($_SESSION["autenticado"] == "1"){
	 ...
	 if(!empty($_POST['select']) && !empty($_POST['palabra']) ){
		 $grupo = new Grupo("","","","");
		 $resp = $grupo->buscarGrupo($_POST['select'],$_POST['palabra']);
		 $_SESSION['grupos'] = serialize($resp);
		 $ver_grupos = 1;
	 }
	 ...
	 if(!empty($_POST['tarea']) && $_POST['tarea'] == 'editar'){
		...
		for($i=0; $i<count($grupos); $i++){
			$grupo = $grupos[$i];
			if($grupo->id==$_POST['id']){
				$_SESSION['grupo']=serialize($grupo);
				unset($_SESSION['grupos']);
				echo "<script> window.location.href='EditarGrupo.php';</script>";
			}
		}
	 }
          ...
          <tr>
			...
			<table width="350" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="BuscarUsuario">BUSCAR GRUPOS EQUIPOS</td>
                  </tr>
                  <tr>
			...
			?>
			  <table width="600" border="1" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
						    <td width="69" align="center"><input name="tarea" type="hidden" id="tarea"/>						      <input name="id" type="hidden" id="id"/></td>
						    <td width="310">&nbsp;</td>
						    <td width="117" align="center" valign="middle">&nbsp;</td>
                            <td width="94" align="center" valign="middle">&nbsp;</td>
					      </tr>
						  <tr>
                            <td width="69" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Código</strong></td>
							<td width="310" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Descripcion </strong></td>
							<td width="117" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Estado</strong></td>
                            <td width="94" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Editar</strong></td>
						  </tr>
						  <?php
							...
							<tr align="left" class="TablaUsuarios">
                            	<td width="69" align="center"><?php echo ($grupo->codigo); ?></td>
								<td width="310"><?php echo ($grupo->descripcion); ?></td>
							  	<td width="117" align="left" valign="middle"><?php if($grupo->estado==1){echo "ACTIVO";}else{echo "INACTIVO";} ?></td>
                                <td width="94" align="center" valign="middle"><a href="javascript:enviar_form_clientes('editar','<?php echo $grupo->id; ?>')"><img src="imagenes/editar.png" width="32" height="32" /></a></td>
                          </tr>
						<?php } ?>
			  </table>
						<?php
