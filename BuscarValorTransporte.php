<?php
 ...
 if($_SESSION["autenticado"] == "1"){
	 ...
	 if(!empty($_POST['select']) && !empty($_POST['palabra']) ){
		 ...
		 $resp = $Valortransporte->buscarValorTransporte($_POST['select'],$_POST['palabra']);
		 $_SESSION['valortransportes'] = serialize($resp);
		 $ver_transportes = 1;
	 }
	  
	 if(!empty($_POST['tarea']) && $_POST['tarea'] == 'editar'){
	 	$valortransportes=unserialize($_SESSION['valortransportes']);
		for($i=0; $i<count($valortransportes); $i++){
			$valortransporte = $valortransportes[$i];
			if($valortransporte->id==$_POST['id']){
				$_SESSION['valortransporte']=serialize($valortransporte);
				unset($_SESSION['valortransportes']);
...
<title>Buscar Valor Tranporte</title>
          ...
          <tr>
            <td align="left" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td><a href="CrearValorTransporte.php"><img src="imagenes/nueva_bodega.png" width="32" height="32" title="Nuevo Transporte" /></a></td>
                <td><a href="BuscarValorTransporte.php" target="_parent"><img src="imagenes/buscar.png" alt="buscar" width="32" height="32" border="0" title="Buscar Transporte"/></a></td>
                <td><a href="MenuValorTransporte.php"><img src="imagenes/flecha.png" alt="volver" width="32" height="32" border="0" title="Volver" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <tr>
                <td align="center" valign="middle"><table width="320" height="190" style="background-image:url(imagenes/fondo_buscar.png)" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td width="2%">&nbsp;</td>
                    <td width="51%"><label>
                      <select name="select" id="select" style="height: 20px; width: 150px;" onchange="valcampobusquedavalorTransporte(this.value);">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><label>
                    <input name="palabra" type="text" id="palabra" maxlength="25" />
</label></td>
                  </tr>
                  <tr>
			...
			?>
						<table width="600" border="1" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
							<td width="175" align="center" bgcolor="#CCCCCC"><strong>Ciudad </strong></td>
						  ...
						  <?php
							for ($i=0; $i<count($resp); $i++){
								$Valortransporte = $resp[$i];
							?>
							<tr align="left" class="TablaUsuarios">
								<td width="175"><?php echo ($Valortransporte->ciudad); ?></td>
                                <td width="175"><?php echo ($Valortransporte->valor); ?></td>
							  <td width="100" align="left" valign="middle"><?php if($Valortransporte->estado==1){echo "ACTIVO";}else{echo "INACTIVO";} ?></td>
                                <td width="91" align="center" valign="middle"><a href="javascript:enviar_form_clientes('editar','<?php echo $Valortransporte->id; ?>')"><img src="imagenes/editar.png" width="32" height="32" /></a></td>
                          </tr>
						<?php } ?>
			  </table>
						<?php
