...
if ($_SESSION["autenticado"] == "1") {
    ...
    if ($_POST['tarea'] == 'validar'){
		$proveedor = new Proveedor('','',$_POST['documento'], '', '','','','','','','','','','','','','','','','','');
		$ConsultarProveedor=$proveedor->existeProveedor();
		if(!$ConsultarProveedor){
			$_SESSION['validaprov']=$_POST['documento'];
			echo "<script>window.location.href='CrearProveedor.php';</script>";
		}
		else{
			$resp = $proveedor->buscarProveedor('documento',$_POST['documento']);
			$_SESSION['proveedor']=serialize($resp[0]);
  ...
  <tr>
    <td align="center" valign="top"><form action="" method="post" name="form1" class="FormGeneral" id="form1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="left" valign="middle"><table width="35" border="0" cellspacing="0" cellpadding="0">
            <tr align="center" valign="middle">
              <td><a href="javascript:cliente_val('validar')"><img src="imagenes/seleccionar.png" width="32" height="32" title="Validar Proveedor" /></a></td>
        ...
        <tr>
          <td align="center" valign="middle"><strong>PROVEEDOR</strong></td>
        </tr>
      </table>
            ...
            <tr>
              <td height="132" align="center" valign="top"><table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td colspan="5" align="center">Documento</td>
                  </tr>
                <tr>
                  <td align="center" valign="middle">&nbsp;</td>
                  <td colspan="5" align="center"><input name="documento" type="text" id="placa" size="30" maxlength="15" onKeyPress="javascript:return Numeros(event)" class="campos_mayus" />                    <input name="tarea" type="hidden" id="tarea" class="campos_mayus" /></td>
                  </tr>
                <tr>
                  <td align="center" valign="middle">&nbsp;</td>
